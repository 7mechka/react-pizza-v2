...
import CartPizzaCard from '../components/PizzaBlock/CartPizzaCard';
          ...
          <div className='cart'>
            ...
            <div className='content__items'>
              {globalPizzaList.map((e, i) => (
                <CartPizzaCard
                  {...e}
                  key={generateKey(`${e.title}_${e.type}_${e.size}`)}
                />
              ))}
            </div>
            <div className='cart__bottom'>
              <div className='cart__bottom-details'>
                <span>
                  {' '}
                  Всього піц: <b>{globalPizzaList.length} шт.</b>{' '}
                </span>
                <span>
                  {' '}
                  Сума заказа: <b>{allPizzasPrice()} ₴</b>{' '}
                </span>
              </div>
